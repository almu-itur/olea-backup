 ...
 * @since accesspress Widget Pack 1.0
 */
require get_template_directory() . '/inc/widgets/widget-toggle.php';
 ...
 * Vide CTA Widget
 *
 * @since accesspress Widget Pack 4.0.0
 */
require get_template_directory() . '/inc/widgets/widget-video-cta.php';