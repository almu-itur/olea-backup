 ...
 */
if( ! function_exists( 'accesspress_parallax_new_blog_poston' ) ):
	function accesspress_parallax_new_blog_poston() {

		$byline = sprintf(
			_x( '%s', 'post author', 'accesspress_parallax' ),
			'<span class="author vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '">' . esc_html( get_the_author() ) . '</a></span>'
		);
		echo $byline;
		...
		if ( ! post_password_required() && ( comments_open() || get_comments_number() ) ) {
			echo '<span class="comments-count">';
				comments_popup_link( __( '0 Comment', 'accesspress_parallax' ), __( '1 Comment', 'accesspress_parallax' ), __( '% Comments', 'accesspress_parallax' ) );
			echo '</span>';
		}
